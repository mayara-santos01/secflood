...
('Reverse Lookup', 'Query a name in reverse lookup format (in-addr.arpa)', 'dig -x 10.0.0.1', 27, 'input', '-x', NULL, NULL, 'QUERY OPTIONS'),
('Display Flags', 'Set All Display Flags', 'dig +all example.com', 27, 'checkbox', '+all', NULL, NULL, 'DISPLAY OPTIONS'),
('Do not Display Flags', 'Clear All Display Flags', 'dig +noall example.com', 27, 'checkbox', '+noall', NULL, NULL, 'DISPLAY OPTIONS'),
('Show Answer Section', 'Control Display of Answer Section', 'dig +answer example.com', 27, 'checkbox', '+answer', NULL, NULL, 'DISPLAY OPTIONS'),
('Hide Answer Section', 'Control Display of Answer Section', 'dig +noanswer example.com', 27, 'checkbox', '+noanswer', NULL, NULL, 'DISPLAY OPTIONS'),
('Show Authority Section', 'Control Display of Authority Section', 'dig +authority example.com', 27, 'checkbox', '+authority', NULL, NULL, 'DISPLAY OPTIONS'),
('Hide Authority Section', 'Control Display of Authority Section', 'dig +noauthority example.com', 27, 'checkbox', '+noauthority', NULL, NULL, 'DISPLAY OPTIONS'),
('Show Question Section', 'Control Display of Question Section', 'dig +question example.com', 27, 'checkbox', '+question', NULL, NULL, 'DISPLAY OPTIONS'),
('Hide Question Section', 'Control Display of Question Section', 'dig +noquestion example.com', 27, 'checkbox', '+noquestion', NULL, NULL, 'DISPLAY OPTIONS'),
('Show Stats', 'Control Display of Statistics', 'dig +stats example.com', 27, 'checkbox', '+stats', NULL, NULL, 'DISPLAY OPTIONS'),
